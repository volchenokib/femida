<template>
	...
	>
		<div class="table__title">Top contracts with max CRI</div>
		...
		>
			...
			>
				<template scope="scope">
					<a
						:href="
							`//www.zakupki.gov.ru/epz/order/notice/ea44/view/common-info.html?regNumber=${
